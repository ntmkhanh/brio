...
def main():
    ...
    send_example_telemetry("run_vit5_finetune_v4", model_args, data_args)
    ...
    # if model.config.decoder_start_token_id is None and isinstance(tokenizer, (T5Tokenizer, T5TokenizerFast)):
    ...
    kwargs = {"finetuned_from": model_args.model_name_or_path, "tasks": "công thức: "}
    if data_args.dataset_name is not None:
